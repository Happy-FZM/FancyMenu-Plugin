package de.keksuccino.fancymenu.networking.packet;

import de.keksuccino.fancymenu.networking.PacketRegistry;
import de.keksuccino.fancymenu.networking.packet.commands.closegui.CloseGuiCommandPacketCodec;
import de.keksuccino.fancymenu.networking.packet.commands.layout.command.LayoutCommandPacketCodec;
import de.keksuccino.fancymenu.networking.packet.commands.layout.suggestions.LayoutCommandSuggestionsPacketCodec;
import de.keksuccino.fancymenu.networking.packet.commands.opengui.OpenGuiCommandPacketCodec;
import de.keksuccino.fancymenu.networking.packet.commands.variable.command.VariableCommandPacketCodec;
import de.keksuccino.fancymenu.networking.packet.commands.variable.suggestions.VariableCommandSuggestionsPacketCodec;
